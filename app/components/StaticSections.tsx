...
const ACTIONS = [
  ...
  },
  {
    ...
    desc: "Every pop-up ad is auto-minted as a pump.fun coin -- all 12 launched every 8s, forever.",
  },
  {
    glyph: "boost",
    title: "THE FLYWHEEL",
    ...
    >
      ...
      <div className="xcard">
        ...
        <div className="xcard-bio">
          Auto-minting all 12 ad-coins every 8s. The engine never sleeps. buy
          $AdFund.
        </div>
